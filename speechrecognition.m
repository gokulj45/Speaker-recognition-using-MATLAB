...
a=[m1 m2 m3 m4 m5 m6];
m=max(a);
h=wavread('allowed.wav');
if m<=m1
    soundsc(wavread('one.wav'),50000)
        %soundsc(h,50000)
        display('Signal matched was 1')
elseif m<=m2
    soundsc(wavread('two.wav'),50000)
        soundsc(h,50000)
        display('Signals matched was 2')
elseif m<=m3
    soundsc(wavread('three.wav'),50000)
        %soundsc(h,50000)
        display('Signal matched was 3')
elseif m<=m4
    soundsc(wavread('four.wav'),50000)
       %soundsc(h,50000)
        display('Signal matched was 4')
elseif m<=m5
    soundsc(wavread('five.wav'),50000)
       % soundsc(h,50000)
        display('Signal matched was 5')
else
   %soundsc(wavread('denied.wav'),50000)
   display('Signals not matched')
